...
export const Player = ({ src, autoPlay, muted }: IPlayer) => {
	...
	useEffect(() => {
		...
		// videoApi.addEventListener('volumechange', mutedHandler)
		...
		return () => {
			...
			// videoApi.removeEventListener('volumechange', mutedHandler)
		}
	...
	return (
		<div className={styles.player} ref={playerRef}>
			...
			<div className={styles.player_column}>
				<div
					className={styles.player_rewind}
					ref={leftRewindRef}
					onDoubleClick={rewindLeft}
				></div>
				<div className={styles.player_rewind} onDoubleClick={rewindRight}></div>
			</div>
			<video
				muted={muted}
				autoPlay={autoPlay}
			...
			<div className={styles.player_controls}>
				<div className={styles.player_left}>
					<div className={styles.player_left__column}>
						{!isPlaying ? (
					...
					<div className={styles.player_left__column}>
						<button className={styles.player_volume}>
							{!isMuted ? (
								<svg
									width='14'
									height='19'
							...
							<input
								...
								step={0.1}
								onChangeCapture={(e) =>
									mutedHandler(Number(e.currentTarget.value))
								}
							/>
						</button>
					</div>
				...
				<div className={styles.player_right}>
					<div className={styles.player_quality}>
						<button>
							<svg
								width='19'
								height='20'
					...
					<div className={styles.player_fullscreen}>
